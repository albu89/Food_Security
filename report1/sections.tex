...
For cereals similar to meat we likewise see a high correlation in volume of around 0.82 between the different cereal categories. The products beer, barley, bread, alta and pasta show a strong positive relationship to the cereal categories.   Unlike meat,  the cereal categories show a strong positive relationship with the universal Food Price Index. This is somewhat surprising as meat prices have a stronger influence on the universal Food Price Index then Cereals do \cite{fao2008}. Furthermore the  product pata has a strong linear relationnship with the commodity wheat 0.7212
\begin{figure}[H]
        \centering
...
For price and supply we observe a similar temporal pattern. Both show a continuous activity with one extremely prominent isolated peak. The activity is concentrated symmetrically around those two events , showing abnormal activities for around 9 days before and after. 
 ...
 We manually investigated the two isolated peaks to see if we can attribute them to any discussions relevant to price. The content corresponded to a popular Korean pop band \emph{T-ara }. They released a music video on the 10th of September which caused the first anomaly reaching a  global maximum on the 16th when they announced to collaborate with a famous european DJ  \footnote{http://www.kpopstarz.com/articles/112632/20140916/t-ara-sugar-free.htm}. Similarly in our supply conversation the peak was not caused by supply indicators but was driven by topics entered around health \& life style. 
...
The discussion centred around food price showed 82 events. Tweet activities for food supply resulted in 91 spikes. 80 peaks were detected for food needs and lastly 99 for food poverty. 
...
\begin{description}
 ...
 Events entered around the food supply chain are considered including indicators of food waste. We define Food Loss and Food waste according to Parfitt et al. 's \cite{Julian10} definition. Food Waste refers to Food Loss that occurs at the retailers and consumers side where as the term Food Loss refers to the decrease in food volume that leads to edible food for consumption.
  ...
  IWe define Economic Access according to FAO's \cite{fao2008} definition. Price, expenditure or market indicators fall into this domain.   
...
Yao et al. [ref] suggests that the market can be categorised using the major trend the intermediate trend and the minor trend. Where the major trend lasts more then a year, intermediate trends are anything between 3 weeks to three months. We capture such trends by taking the moving average of 1 week, 2 weeks and 1 month respectively to capture minor ant intermediate trends. Given the limited time frame we chose to exclude major trends. 
...
\begin{tabular}{ |p{2cm}|p{1cm}|p{1cm}|p{1cm}|p{1cm}|p{1cm}|p{1cm}|p{1cm}|p{1cm}|p{1cm}| }
 \hline
 \multicolumn{10}{|c|}{Benchmark Prediction - $RMSE_{Test}$ $(RMSE_{Train}$) } \\
 \hline
