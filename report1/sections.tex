...
We now describe the network like structure of ANFIS
...
Fuzzy Logic is based on fuzzy sets where the requirements for membership are not precisely defined. By introducing the concept of partial membership, the fuzzy set definition accounts for imprecise requirement for the membership of an element in a set. This means the membership function not only give 0 or 1, but can also give values between 0 and 1. The process of changing a real scalar value into a fuzzy value is called fuzzification.
