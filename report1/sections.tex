...
Motivated by this research we try to discover spikes in our twitter conversations entered around Food Security and create a link to events that might have caused them. Such events can play a significant role in explaining food price volatility and spikes. 


We define a spike to be 

IF abs(x-mu) $>$ 3*std  THEN  x is outlier where mu is the mean of the data and std the standard deviation. 




Headey Martin and Anderson have shown that the sequence of export restrictions by India Thailand China and Rusia created panics in the international food market. While domestic prices stayed stable domestic prices are shielded from the full impact. 


The paper differentiates between price spikes and volatility. A price spike is a large and temporary fall in price. Price volatility is a long-term price movement indicating the risk associated with price changes. It is usually measured in terms of price dispersion from the mean.

The finding were that exogenous shocks as well as the linkages between food, energy, and financial markets play a significant role in explaining food price volatility and spikes. Furthermore to demand and supply shocks speculation is an important factor in explaining and triggering extreme price spikes. 

The effect of oil prices on food price spikes has emerged as significant only in recent years. Financial crisis exerts a strong impact on food price volatility, which confirms the increas- ing link between financial and commodity markets.
